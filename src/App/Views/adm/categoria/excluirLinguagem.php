...
if(isset($_GET['id'])){
    ...
    $sql -> selectWhere('linguagem', 'linguagem', 'id_linguagem', $_GET['id']);
            ...
            <div class="conteudo">
                ...
                <div class="ajuste">
                    <div class="form">
                        ...
                        echo "Deseja realmete excluir a linguagem: ".$linguagem."?<br><br>";
                        ...
                        if(isset($_POST['excluir'])){
                            ...
                            $result = $sql -> delete('lingXpal', 'id_linguagem', $_GET['id']);

                            $result = $sql -> delete('linguagem', 'id_linguagem', $_GET['id']);
