...
if(isset($_GET['id'])){
    ...
    $sql -> selectWhere('palavras', 'palavra', 'id_palavra', $_GET['id']);
            ...
            <div class="conteudo">
                ...
                <div class="ajuste">
                    <div class="form">
                        ...
                        echo "Deseja realmete excluir a palavra: ".$palavra."?<br><br>";
                        ...
                        if(isset($_POST['excluir'])){
                            ...
                            $result = $sql -> delete('palavras', 'id_palavra', $_GET['id']);

                            $result = $sql -> delete('lingXpal', 'id_palavra', $_GET['id']);
